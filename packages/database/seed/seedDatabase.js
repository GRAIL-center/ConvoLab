...
Do not begin your response with "COACH:" or any role label.`;
function withLiveDebateFormat(prompt) {
    return `${prompt.trim()}
...
const SCENARIOS = [
    {
        ...
        description: 'Practice navigating political disagreements with a family member during a holiday dinner.',
...
Start the conversation with a provocative political statement about current events.`,
    ...
    },
    {
        ...
        description: 'A politically engaged progressive who argues from systemic and structural reasoning.',
        partnerPersona: 'Marcus Johnson',
        partnerSystemPrompt: withLiveDebateFormat(`You are Marcus Johnson, a male politically engaged, highly educated progressive living in a mid-sized U.S. city.
...
- Keep responses concise enough to work well in a live debate format`),
    ...
    },
    {
        ...
        partnerSystemPrompt: withLiveDebateFormat(`You are Maya Johnson, a female politically engaged, highly educated progressive living in a mid-sized U.S. city.
...
- Keep responses concise enough to work well in a live debate format`),
    ...
    },
    {
        ...
        description: 'A blunt right-populist who argues from fairness, accountability, and distrust of elites.',
...
- End naturally, often with a pushback, challenge, or question.`,
    ...
    },
    {
        ...
        partnerUseWebSearch: true,
        coachUseWebSearch: false,
        description: 'Practice giving constructive feedback to a defensive coworker about missed deadlines.',
 ...
 */
export async function seedReferenceData(prisma, options = {}) {
 ...
 * Safe to call multiple times - uses upserts.
 */
export async function seedTestData(prisma, options = {}) {
    const log = options.log ?? console.log;
 ...
 */
export async function isDatabaseEmpty(prisma) {
 ...
 */
export async function seedIfEmpty(prisma, options = {}) {
